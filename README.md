...
Key Features
              ...
              * Automated resume evaluation report generation
...
How It Works
            ...
            4. ATS score and match level are calculated
            5. A structured evaluation report is generated
...
Tech Stack
         ...
         * Text parsing and regex for data extraction
...
What I Learned
         ...
         * Handling errors and edge cases in automation flows
         * Building end-to-end AI automation solutions
         
------------------------------------------------------------------------------------------------------------------------------------------
Future Enhancements:
         * Job description–based resume comparison
         * Multi-language and multi format resume support
         * Resume score visualization
         * Integration with messaging platforms like Telegram or WhatsApp
         
-------------------------------------------------------------------------------------------------------------------------------------------
Workflow Screenshot: 
<img width="1746" height="695" alt="image" src="https://github.com/user-attachments/assets/4b52a9f0-9ac8-453c-9f45-98905bd225fe" />
